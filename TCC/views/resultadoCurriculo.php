...
<body>
    ...
    <div class="lista-curriculos">
        ...
        foreach($resultados as $resultado){?>
            ...
            <td style="color:#FFF;"><a href='../views/curriculo.php?id=<?=$resultado['id']?>'><svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-eye" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
