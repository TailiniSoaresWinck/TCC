    ...
    <div class="info">
        <h5>Atualize os campos abaixo:</h5>
                        ...
                        <form action="../process/curriculo.php" method="POST">
                            ...
                            <div class="conteudo">
                                <div class="control">
                                    <input name="instituicao" type="text"  value="<?=$row_curriculo['instituicao'];?>" autofocus>
                                </div>
                            </div>
                            <div class="conteudo">
                                <div class="control">
                                    <input name="nivel" type="text"  value="<?=$row_curriculo['nivel'];?>" autofocus>
                                </div>
                            </div>
                            <div class="conteudo">
                                <div class="control">
                                    <input name="inicio" type="date"  value="<?=$row_curriculo['inicio'];?>" autofocus>
                                </div>
                            </div>
                            <div class="conteudo">
                                <div class="control">
                                    <input name="fim" type="date"  value="<?=$row_curriculo['fim'];?>" autofocus>
                                </div>
                            </div>
                            <div class="conteudo">
                            ...
                            <div class="conteudo">
                                <div class="control">
                                    <input name="admissao" type="date"  value="<?=$row_curriculo['admissao'];?>" autofocus>
                                </div>
                            </div>
                            <div class="conteudo">
                                <div class="control">
                                    <input name="demissao" type="date"  value="<?=$row_curriculo['demissao'];?>" autofocus>
                                </div>
                            </div>
                            <div class="conteudo">
                            ...
                            <div class="conteudo">
                                <div class="control">
                                    <input name="data" type="date"  value="<?=$row_curriculo['data'];?>" autofocus>
                                </div>
                            </div>
