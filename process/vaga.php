...
if($metodo==="GET"){
    ...
    if($type==="cadastrar_vaga"){
        if(empty($_POST['titulo'] && $_POST['cargo'] && $_POST['descricao'] && $_POST['beneficio'] && $_POST['exigencia'])){
            ...
            header('Location:'.URL_VIEWS.'/criaVaga.php');
        }
        else{
            $titulo = $_POST['titulo'];
            $cargo = $_POST['cargo'];
            ...
            header('Location:'.URL_VIEWS.'/listaVagas.php');
            }
            else{
...
>>>>>>> 76f60573f412bd144741b24927ff095a90e84d46:TCC/process/vaga.php
}